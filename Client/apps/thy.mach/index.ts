namespace hpny {
    ...
    moon.element.addEventListener('click', function(this: HTMLElement) {
        if (this.matches('.clickable') == false) return

        $owl_note.toggle();
        $root.find<HTMLVideoElement>('.new-year-modal video')[0].play();
